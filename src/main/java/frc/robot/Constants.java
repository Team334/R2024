...
public final class Constants {
  ...
  public static class Presets {
    ...
    static {
      ...
      //NEW
      SHOOTER_DISTANCE_ANGLE.put(1.2831657001191088, 58.11767578125);
      SHOOTER_DISTANCE_ANGLE.put(1.6654924213320106, 50.96871512276786); 
      SHOOTER_DISTANCE_ANGLE.put(1.9201489414312054, 49.35843331473214); 
      SHOOTER_DISTANCE_ANGLE.put(2.439768852658054, 47.252197265625);
      SHOOTER_DISTANCE_ANGLE.put(2.682571846417269, 40.392020089285715); 


      //NYC Regional
      // SHOOTER_DISTANCE_ANGLE.put(1.451101767427388, 53.738839285714285);
      // SHOOTER_DISTANCE_ANGLE.put(1.414185456363615, 54.87984793526786);
      // SHOOTER_DISTANCE_ANGLE.put(2.1285865676795237, 48.21742466517858);
      // SHOOTER_DISTANCE_ANGLE.put(2.487748521528895, 42.895333426339285);
      // SHOOTER_DISTANCE_ANGLE.put(3.0782159514727163, 40.37318638392857);
      // SHOOTER_DISTANCE_ANGLE.put(2.1774294348986682, 47.06856863839286);
      // SHOOTER_DISTANCE_ANGLE.put(3.2592748390692776, 37.72705078125);
      // SHOOTER_DISTANCE_ANGLE.put(0.8629958355261691, 64.55252511160714);
    };
    ...
    static {
      ...
      //NEW
      ELEVATOR_DISTANCE_HEIGHT.put(1.2831657001191088, 0.077572265625); 
      ELEVATOR_DISTANCE_HEIGHT.put(1.6654924213320106, 0.077572265625); 
      ELEVATOR_DISTANCE_HEIGHT.put(1.9201489414312054, 0.077572265625); 
      ELEVATOR_DISTANCE_HEIGHT.put(2.439768852658054, 0.0); 
      ELEVATOR_DISTANCE_HEIGHT.put(2.682571846417269, 0.029138671875); 

      //NYC Regional
      // ELEVATOR_DISTANCE_HEIGHT.put(1.451101767427388, 0.05916796875);
      // ELEVATOR_DISTANCE_HEIGHT.put(1.414185456363615, 0.062373046875);
      // ELEVATOR_DISTANCE_HEIGHT.put(2.1285865676795237, 0.0343037109375);
      // ELEVATOR_DISTANCE_HEIGHT.put(2.487748521528895, 0.017803710937499998);
      // ELEVATOR_DISTANCE_HEIGHT.put(3.0782159514727163, 0.021448242187499997);
      // ELEVATOR_DISTANCE_HEIGHT.put(2.1774294348986682, 0.046933593749999995);
      // ELEVATOR_DISTANCE_HEIGHT.put(3.2592748390692776, 0.0175693359375);
